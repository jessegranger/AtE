...
namespace AtE {
	...
	public static class SpriteController {
		...
		private const int spriteTilesWidth = 14; // there are 7 sprites wide (each 64 pixels)
		private const int spriteTilesHeight = 16; // there are 8 rows of sprites
		...
		private static RectangleF GetUV(int iconIndex) {
			...
			// return new RectangleF(0, 0, 1f / spriteTilesWidth, 1f / spriteTilesHeight);
