...
namespace AtE {
		...
		internal class Runner : State {
			readonly Func<State, long, State> F;
			public Runner(Func<State, long, State> func) => F = func;
			public override State OnTick(long dt) => F(this, dt);
			public override string Name => name;
			private readonly string name = "...";
			public Runner(string name, Func<State, long, State> func) : this(func) => this.name = name;
			...
			public Runner(string name, Func<State, long, State> func, State next) : this(name, func) => this.Next = next;
		}
}
